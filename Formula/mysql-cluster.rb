class MysqlCluster < Formula
  ...
  bottle do
    rebuild 1
    sha256 "9ad951512bce5f2ea416db16da7ca00b10bde573ea36a3b423b19df3104a9bcb" => :mojave
    sha256 "080e2f7fed1ac3e40324e42624e7a5a81a4dd328787f6d06828534ffd3b07872" => :high_sierra
    sha256 "50e9a5d695fedf6e7d08e961274a452538967a0fd6f3cf4d85da2653cccea3d4" => :sierra
  end
  ...
  def install
    ...
    plist_path("ndb_mgmd").write ndb_mgmd_startup_plist("ndb_mgmd").to_plist
    plist_path("ndb_mgmd").chmod 0644
    plist_path("ndbd").write ndbd_startup_plist("ndbd").to_plist
    plist_path("ndbd").chmod 0644
    plist_path("mysqld").write mysqld_startup_plist("mysqld").to_plist
