class Travis < Formula
  ...
  bottle do
    rebuild 1
    sha256 "c137c188a86462059f9d4d244bff0cce1c78a37b5fe0cec1b5134c261fba7764" => :catalina
    sha256 "f40c79d2c2f9e493e4d717e5562fa2e85c3e70fb30b9d7cbd3bd2bb1e00ac323" => :high_sierra
  end
