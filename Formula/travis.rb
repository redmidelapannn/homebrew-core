class Travis < Formula
  ...
  bottle do
    rebuild 1
    sha256 "83af62ffac687078e3dd927742e157ffca46d018df9ed8b1eced8a96477085c6" => :catalina
    sha256 "857472e089f9b4d0477bdbed2441a1864ab6ed0a196a0216c018a445ae114893" => :high_sierra
  end
