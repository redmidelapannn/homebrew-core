class Travis < Formula
  ...
  bottle do
    rebuild 1
    sha256 "4aa3103394b06c3112ec69ca523c458ca405464626754f8daa8c9524f77877c7" => :catalina
    sha256 "cf6028bae2f3e02416a394c8cd34da1ace055476a697c38ab74c052bc1b7db3a" => :high_sierra
  end
