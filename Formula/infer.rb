class Infer < Formula
  ...
  bottle do
    cellar :any
    rebuild 2
    sha256 "84d129e7048c3d7a0052dfc05f51b3f101af7e7b0b1f0c03d8572169cf0b0123" => :mojave
    sha256 "580f0df92fb46db1769f97a033475a89cb7e0ed6bd6b393d1c432b25a469a927" => :high_sierra
  end
