class Shogun < Formula
  ...
  def install
    ...
    args = std_cmake_args + [
      ...
      cmake_use("r", "INTERFACE_R"),
      cmake_use("octave", "INTERFACE_OCTAVE"),
      cmake_use("lua", "INTERFACE_LUA"),
      cmake_use("python", "INTERFACE_PYTHON"),
      cmake_use("java", "INTERFACE_JAVA"),
    ]

    virtualenv_install_with_resources if build.with? "python"
