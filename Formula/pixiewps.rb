class Pixiewps < Formula
  desc "An offline WPS brute-force utility"
  ...
  def install
    cd "src" do
      ...
      system "make", "install", "PREFIX=#{prefix}", "LOCDIR=#{bin}"
    end
  end

  test do
    system "#{bin}/pixiewps", "-a", "7f:de:11:b9:69:1c:de:26:4a:21:a4:6f:eb:3d:b8:aa:aa:d7:30:09:09:32:b8:24:43:9b:e0:91:78:e7:6f:2c", \
