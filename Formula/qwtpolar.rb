class Qwtpolar < Formula
  ...
  bottle do
    rebuild 1
    sha256 "b9064d2a374bdd2e2fbda2186cd5375ed1aae487c644b2dc7d19ec9b9e07a091" => :mojave
    sha256 "a0130233112d2c523a276936bfb9e4f40464c18e6de25d81b5a7a5d3271b65b4" => :high_sierra
  end
