class Rust < Formula
  ...
  stable do
    ...
    resource "racer" do
      url "https://github.com/phildawes/racer/archive/1.2.5.tar.gz"
      sha256 "3b932331f4778b6c0bb092f92783ec616e939b15f85f58d069f65a85c921db66"
    end
  ...
  bottle do
    rebuild 2
    sha256 "3d70b1df48aea1f231b11dbbaabcaf18d681f58ff9185ea3028ebc43c86f3823" => :sierra
    sha256 "c63027b0a31fd3b26220aa8dcf63d3bcfb7c5c4ed88c9862bd372860686abc0a" => :el_capitan
    sha256 "8d2af99d68791fc28af5376aaab3aa232238027e4991815aa1faa58909f826f6" => :yosemite
  end
  ...
  option "with-racer", "Build Racer code completion tool, and retains Rust sources."
  ...
  def install
    ...
    if build.with? "racer"
      ...
      # remove any binary files as homebrew will run ranlib on them and barf, keep everything else
