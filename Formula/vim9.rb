class Vim9 < Formula
  desc "Experimental fork of Vim, to make Vim script faster and better"
  homepage "https://github.com/brammool/vim9"
  # vim should only be updated every 50 releases on multiples of 50
  url "https://github.com/brammool/vim9/archive/v8.2.0079.tar.gz"
