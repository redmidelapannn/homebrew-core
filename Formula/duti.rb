class Duti < Formula
  ...
  patch do
    url "https://patch-diff.githubusercontent.com/raw/moretension/duti/pull/32.diff?full_index=1"
    sha256 "8c17d22b1889c2731480086f948395efb382c86882222378d193d97af7e4dae4"
  end
