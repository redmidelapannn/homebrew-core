class Latexml < Formula
  ...
  resource "Image::Size" do
    url "http://www.cpan.org/authors/id/R/RJ/RJRAY/Image-Size-3.300.tar.gz"
    sha256 "53c9b1f86531cde060ee63709d1fda73cabc0cf2d581d29b22b014781b9f026b"
  end

  # IO::String
  resource "IO::String" do
    url "http://www.cpan.org/authors/id/G/GA/GAAS/IO-String-1.08.tar.gz"
  ...
  resource "common::sense" do
    url "http://www.cpan.org/authors/id/M/ML/MLEHMANN/common-sense-3.74.tar.gz"
    sha256 "771f7d02abd1ded94d9e37d3f66e795c8d2026d04defbeb5b679ca058116bbf3"
  end
  resource "Types::Serialiser" do
    url "http://www.cpan.org/authors/id/M/ML/MLEHMANN/Types-Serialiser-1.0.tar.gz"
    sha256 "7ad3347849d8a3da6470135018d6af5fd8e58b4057cd568c3813695f2a04730d"
  end
  # Canary::Stability
  resource "Canary::Stability" do
    url "http://www.cpan.org/authors/id/M/ML/MLEHMANN/Canary-Stability-2012.tar.gz"
    sha256 "fd240b111d834dbae9630c59b42fae2145ca35addc1965ea311edf0d07817107"
  end
  resource "JSON::XS" do
    url "http://www.cpan.org/authors/id/M/ML/MLEHMANN/JSON-XS-3.04.tar.gz"
  ...
  resource "Test::Needs" do
    url "http://www.cpan.org/authors/id/H/HA/HAARG/Test-Needs-0.002005.tar.gz"
    sha256 "5a4f33983586edacdbe00a3b429a9834190140190dab28d0f873c394eb7df399"
  end
  resource "URI" do
    url "http://www.cpan.org/authors/id/E/ET/ETHER/URI-1.73.tar.gz"
  ...
  resource "Test::RequiresInternet" do
    url "http://www.cpan.org/authors/id/M/MA/MALLEN/Test-RequiresInternet-0.05.tar.gz"
  ...
  resource "LWP::MediaTypes" do
    url "http://www.cpan.org/CPAN/authors/id/G/GA/GAAS/LWP-MediaTypes-6.02.tar.gz"
  ...
  # IO::HTML
  resource "IO::HTML" do
    url "http://www.cpan.org/CPAN/authors/id/C/CJ/CJM/IO-HTML-1.001.tar.gz"
    sha256 "ea78d2d743794adc028bc9589538eb867174b4e165d7d8b5f63486e6b828e7e0"
  end
  # Try::Tiny
  resource "Try::Tiny" do
    url "http://www.cpan.org/CPAN/authors/id/E/ET/ETHER/Try-Tiny-0.30.tar.gz"
    sha256 "da5bd0d5c903519bbf10bb9ba0cb7bcac0563882bcfe4503aee3fb143eddef6b"
  end
  # HTTP::Date
  resource "HTTP::Date" do
    url "http://www.cpan.org/CPAN/authors/id/G/GA/GAAS/HTTP-Date-6.02.tar.gz"
    sha256 "e8b9941da0f9f0c9c01068401a5e81341f0e3707d1c754f8e11f42a7e629e333"
  end
  resource "HTTP::Message" do
    url "http://www.cpan.org/CPAN/authors/id/O/OA/OALDERS/HTTP-Message-6.14.tar.gz"
  ...
  resource "HTTP::Cookies" do
    url "http://www.cpan.org/authors/id/O/OA/OALDERS/HTTP-Cookies-6.04.tar.gz"
  ...
  resource "Test::Fatal" do
    url "http://www.cpan.org/authors/id/R/RJ/RJBS/Test-Fatal-0.014.tar.gz"
  ...
  resource "Net::HTTP" do
    url "http://www.cpan.org/authors/id/O/OA/OALDERS/Net-HTTP-6.17.tar.gz"
    sha256 "1e8624b1618dc6f7f605f5545643ebb9b833930f4d7485d4124aa2f2f26d1611"
  end
  resource "LWP" do
    url "http://www.cpan.org/authors/id/E/ET/ETHER/libwww-perl-6.31.tar.gz"
    sha256 "525d5386d39d1c1d7da8a0e9dd0cbab95cba2a4bfcfd9b83b257f49be4eecae3"
  end

  # MIME::Base64
  resource "MIME::Base64" do
    url "http://www.cpan.org/authors/id/G/GA/GAAS/MIME-Base64-3.15.tar.gz"
    sha256 "7f863566a6a9cb93eda93beadb77d9aa04b9304d769cea3bb921b9a91b3a1eb9"
  end

  # Parse::RecDescent
  resource "Parse::RecDescent" do
    url "http://www.cpan.org/authors/id/J/JT/JTBRAUN/Parse-RecDescent-1.967015.tar.gz"
  ...
  # url "http://www.cpan.org/authors/id/M/MA/MAREKR/Pod-Parser-1.63.tar.gz"
  # sha256 "dbe0b56129975b2f83a02841e8e0ed47be80f060686c66ea37e529d97aa70ccd"
  # end

  # Text::Unidecode
  resource "Text::Unidecode" do
    url "http://www.cpan.org/authors/id/S/SB/SBURKE/Text-Unidecode-1.30.tar.gz"
  ...
  resource "XML::NamespaceSupport" do
    url "http://www.cpan.org/authors/id/P/PE/PERIGRIN/XML-NamespaceSupport-1.12.tar.gz"
    sha256 "47e995859f8dd0413aa3f22d350c4a62da652e854267aa0586ae544ae2bae5ef"
  end
  # XML::SAX::Base
  resource "XML::SAX::Base" do
    url "http://www.cpan.org/authors/id/G/GR/GRANTM/XML-SAX-Base-1.09.tar.gz"
  ...
  resource "XML::LibXML" do
    url "http://www.cpan.org/authors/id/S/SH/SHLOMIF/XML-LibXML-2.0132.tar.gz"
  ...
  resource "UUID::Tiny" do
    url "http://www.cpan.org/authors/id/C/CA/CAUGUSTIN/UUID-Tiny-1.04.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      You can install LaTeX here: http://www.tug.org/mactex/.
    EOS
  end
