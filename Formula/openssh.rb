class Openssh < Formula
  ...
  url "https://www.mirrorservice.org/pub/OpenBSD/OpenSSH/portable/openssh-7.7p1.tar.gz"
  mirror "https://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-7.7p1.tar.gz"
  version "7.7p1"
