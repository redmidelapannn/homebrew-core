class OpensslAT11 < Formula
  ...
  mirror "https://dl.bintray.com/homebrew/mirror/openssl@1.1--1.1.1e.tar.gz"
  mirror "https://www.mirrorservice.org/sites/ftp.openssl.org/source/openssl-1.1.1e.tar.gz"
