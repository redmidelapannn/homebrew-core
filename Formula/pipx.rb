class Pipx < Formula
  ...
  bottle do
    ...
    sha256 "6bffcdc5dd34b0c9d1165a901cfabe7ee767b9f44a8acc20e3cd9442b0285d0b" => :mojave
    sha256 "46872c5c10f20f1206a56ea51a5dc818c652dcf2d53525283ff5e523fb4bd5a5" => :high_sierra
  end
