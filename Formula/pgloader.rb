class Pgloader < Formula
  ...
  bottle do
    sha256 "7464061f0e1c3a745eecdc320400aad55b7db2730215e4e62bc9f4ec459e72d2" => :catalina
    sha256 "e431aa7f741c45addadbef8c541135522be104c5f1a83fb6fa8f73657fa8c08f" => :mojave
    sha256 "c7465e4903d378dbb758da9fbba69dcf392ebc0bb13373fdafc99c1057413bbe" => :high_sierra
  end
  ...
  resource "cl-abnf" do
    url "http://beta.quicklisp.org/archive/cl-abnf/2019-05-21/cl-abnf-20190521-git.tgz"
  ...
  resource "cl-containers" do
    url "http://beta.quicklisp.org/archive/cl-containers/2020-02-18/cl-containers-20200218-git.tgz"
  ...
  resource "cl-mssql" do
    url "http://beta.quicklisp.org/archive/cl-mssql/2019-08-13/cl-mssql-20190813-git.tgz"
  ...
  resource "closer-mop" do
    url "http://beta.quicklisp.org/archive/closer-mop/2020-02-18/closer-mop-20200218-git.tgz"
  ...
  resource "esrap" do
    url "http://beta.quicklisp.org/archive/esrap/2020-02-18/esrap-20200218-git.tgz"
  ...
  resource "ironclad" do
    url "http://beta.quicklisp.org/archive/ironclad/2020-02-18/ironclad-v0.48.tgz"
  ...
  resource "pgloader" do
    url "http://beta.quicklisp.org/archive/pgloader/2019-02-02/pgloader-v3.6.1.tgz"
    sha256 "ef8091f427ff9cef81576351597e6b863014f01eaf1c0af3e77fcf8a6b9ea925"
  end

  resource "postmodern" do
    url "http://beta.quicklisp.org/archive/postmodern/2020-02-18/postmodern-20200218-git.tgz"
  ...
  resource "uuid" do
    url "http://beta.quicklisp.org/archive/uuid/2018-08-31/uuid-20180831-git.tgz"
