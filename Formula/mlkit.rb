class Mlkit < Formula
  ...
  url "https://github.com/melsman/mlkit/archive/mlkit-4.3.18.tar.gz"
  sha256 "b2c17bf0fc51349f5191428cb08f9dc000edff766077b1ee19af3dcff4de2a9f"
  head "https://github.com/melsman/mlkit.git"

  bottle do
    sha256 "323503749ebe84c69ee14b169c97eb09d77fd4d8399e5b9d9cb9dd3bdd53fd58" => :sierra
  end
