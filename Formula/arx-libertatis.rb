class ArxLibertatis < Formula
  ...
  bottle do
    cellar :any
    rebuild 1
    sha256 "8752e6e6cc9e49f5cd7f2d10ed9989bcde90443313a7737843ba2ae1925e1f0d" => :catalina
    sha256 "a46c4e277ba2e1ceb5aef712926bf56d0466b6473c6153291c863836c93a37d4" => :mojave
    sha256 "14a05e7145a8cfb6fb511ff166c90e82fb54da4cf45a65bfdc740474a8176967" => :high_sierra
  end
