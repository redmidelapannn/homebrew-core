class Apcupsd < Formula
  ...
  bottle do
    rebuild 2
    sha256 "680dcb86dbf3f942172cb9e324a043a7475d7c3d3554afe2fe32b18def8261b7" => :mojave
    sha256 "3946625a3b0b5ae045981321dfbb07f109ac3f5236a539e51800988639f50db3" => :high_sierra
  end
