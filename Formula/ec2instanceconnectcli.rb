class Ec2instanceconnectcli < Formula
  ...
  resource "botocore" do
    url "https://files.pythonhosted.org/packages/2f/b9/45ec3d7a5ec4423a0ce3fae238172fdb8f36b7241b0f1d7b9a88ed353ecd/botocore-1.12.181.tar.gz"
  ...
  test do
    assert_match(/specify a region/i, shell_output("#{bin}/mssh i-1234", 1))
  end
end
