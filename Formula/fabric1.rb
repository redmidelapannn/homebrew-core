class Fabric1 < Formula
  include Language::Python::Virtualenv

  desc "Python library that executes shell commands over SSH"
  ...
  conflicts_with "fabric", :because => "I haven't tested installing fabric 1.x alongside fabric 2.x"
