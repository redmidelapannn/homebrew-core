class AwsElasticbeanstalk < Formula
  ...
  bottle do
    cellar :any
    rebuild 1
    sha256 "c872186d764bf95b2adce44732e27b3078b565a0eec34a95d0bb4a4ae1956a98" => :mojave
    sha256 "6537be5820008a62a328e018561b0a030ef264872ae3e66fd9c1fdafac601d6e" => :high_sierra
  end
