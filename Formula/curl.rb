class Curl < Formula
  ...
  mirror "https://github.com/curl/curl/releases/download/curl-7_55_1/curl-7.55.1.tar.xz"
  mirror "http://curl.askapache.com/download/curl-7.55.0.tar.bz2"
  sha256 "3eafca6e84ecb4af5f35795dee84e643d5428287e88c041122bb8dac18676bb7"

  bottle do
    cellar :any
    rebuild 1
    sha256 "ba487bdbf792132bce02f5c0dfa89d4c3d26c96fb0d3c2c6eab3f053775373bc" => :sierra
    sha256 "7768bfc8341d19bae5743dc038c75fc16d450b564b675ab2dbec4f3f92521b51" => :el_capitan
    sha256 "c049a36a0b90027ac2e9707f35295cea9b3d6814aa025ebe9240734c2388af80" => :yosemite
  end
