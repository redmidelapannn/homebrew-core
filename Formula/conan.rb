class Conan < Formula
  ...
  url "https://pypi.python.org/packages/9d/e3/1e8082abbe379e430c6e70fd03ac08b443a065b8f33ff171efa2ff629069/conan-0.9.3.tar.gz"
  sha256 "f8eb096507ac47f1c83636d4ac0cdba4b291b0293794bc74eb6edba593b14f0a"

  bottle do
    cellar :any_skip_relocation
    sha256 "0a5f8c3892b22ed5a344817db675c9a33085cdb4f649c5d15c16eb40a4454854" => :mavericks
  end
  ...
  def install
    ...
    %w[backport_ipaddress boto bottle cffi cfgparse colorama cryptography enum34 fasteners idna ipaddress monotonic ndg-httpsclient passlib patch pyasn pyasn1 pycparser PyJWT pyOpenSSL PyYAML requests six].each do |r|
      resource(r).stage do
